...
/// Pantalla de bloqueo para sesiones no-admin en Flutter Web.
///
/// El panel web está reservado al rol administrador. Cuando un docente queda
/// autenticado en web (p. ej. una sesión previa), se muestra esta pantalla en
/// lugar del dashboard móvil, invitándolo a usar la app móvil y a cerrar sesión.
///
...
class WebRoleBlockedScreen extends StatelessWidget {
  const WebRoleBlockedScreen({super.key});
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Acceso docente desde la app móvil',
                  ...
                  const Text(
                    'El acceso docente está disponible desde la aplicación móvil.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 15,
                      height: 1.5,
